...
class Teacher(models.Model):
    ...
    national_card_image = models.ImageField(upload_to='images/',blank=True, help_text='عکس خود را اینجا بارگذاری کنید')
    degree_image = models.ImageField(upload_to="images/",blank=True, help_text='عکس مدرک تحصیلی خود را بارگذاری کنید')
    ...
    sample_video = models.FileField(upload_to='videos/',blank=True,validators=[FileExtensionValidator(allowed_extensions= ['mp4']) ] , help_text='یک ویدیو حداکثر سه دقیقه از تدریس خود بارگذاری کنید')
